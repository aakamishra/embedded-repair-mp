...
class LineFollowerBot:
    ...
    def _set_wheel_torque(self, fl_torque, fr_torque):
        """
    ...
    def _power_to_volts(self, fl_pow, fr_pow):
        """
        ...
        return fl_pow * self.volts, fr_pow * self.volts
    ...
    def apply_action(self, action):
        ...
        :return: None
        """
        fl_volts, fr_volts = self._power_to_volts(*action)
        fl_vel, fr_vel = self._get_wheel_velocity()
        ...
        self._set_wheel_torque(fl_torque, fr_torque)
