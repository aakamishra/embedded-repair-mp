...
if __name__ == '__main__':
    custom_env_args = {
        'gui': False,
        'hardware_label': np.ones(2),
        'model_path': None, 
        'data_collection_file': None,
        'number_of_wheels': 2,
        'simulated_firmware_file':"/Users/aakamishra/school/cs329m/embedded-repair-mp/gym_line_follower/line_follower_bot_two_wheel_reference.py",
        'urdf_file':'two_wheel_robot.urdf',
    }
    env = gym.make("LineFollower-v0", **custom_env_args)
    train(env, "ddpg_two_wheels_test", steps=200000, pretrained_path='/Users/aakamishra/school/cs329m/embedded-repair-mp/models/ddpg_two_wheels_test/last_weights.h5f')
    rewards = []
    steps = []
    for i in range(50):
        reward, step = test(env, "models/ddpg_two_wheels_test/last_weights.h5f")
